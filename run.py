...
def game():
    ...
    """
    question_one = input(
    "You open your eyes to find that you can see snow miles on end.\
      A polar bear appears charging at you some 50 meters away. You have 2\
        options, start running or lay on the ground and play dead.\
          Type run or dead: ").lower().strip()
    ...
    if question_one == "run" :
        ...
        question_two = input("That was a clever move.\
          The coast is now clear, you start walking and 5 minutes later you\
            come accross a paddle boat and a sleight. Pick one to continue\
              your journey. Type paddle or sleigh: ").lower().strip()

        if question_two =="paddle" : 
            question_three = input("That turned out to be a wise choice because you soon\
                come across a river and use your boat to get across. Now on the other side you\
                      find a jungle, deep in this jungle you bump into a tiger. Do you climb a tree or\
                           approach the tiger to reassure him that you are friendly? Type climb or approach: ").lower().strip() 
                           
                                 if question_three == "tree" :
                      question_four = input("Well done, getting high up is the smart\
                     thing to do. The coast looks clear but you can not be too 100% certain.\
                          Do you take a nap until to wait til it gets dark or do you climb \
                              down to continue your journey? Type nap or down: ").lower().strip()
                              
                     if question_four == "down" :
                    question_five = input("You make your way through the jungle\
                         and come upon a treasure chest with a key. Do you open it \
                             or keep walking? Type open or walk :").lower().strip()
